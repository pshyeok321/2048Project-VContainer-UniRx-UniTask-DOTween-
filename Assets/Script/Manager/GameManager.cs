...
public class GameManager : MonoBehaviour
{
	...
	[Inject]
	public void Construct(TileManager tileManager, GameEvents events, ScoreModel scoreModel, PlusModel plusModel, GameOverModel gameOverModel) // ★ GameEvents 주입 추가
	{
		this.tm = tileManager;
